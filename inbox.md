...
- Augment: https://www.augmentcode.com/blog
- LangChain: https://blog.langchain.com/
- LatentSpace: https://www.latent.space/archive?sort=new
实现讲解
https://lexfridman.com/cursor-team-transcript/
Cursor团队访谈
https://githubnext.com/projects/continuous-ai
github 介绍continuous-ai的概念
https://www.latent.space/p/claude-code
Claude Code: Anthropic's Agent in Your Terminal
Apply
（已处理：cursor-instant-apply、aider-unified-diffs）
Next Edit
（已处理：zed-edit-prediction、continue-instinct、copilot-nes、augment-next-edit）
Speculative Edit
（已处理：huggingface-assisted-generation）
Edit Tool
（已处理：code-surgery-edit-tools）
流行概念
Agent
Building effective agents
https://www.anthropic.com/engineering/building-effective-agents
年终总结：2025年 AI 产品及架构演进深度研究报告
https://blog.zihanjian.com/article/2b69db82-fa86-80f4-abc2-f6a70258f7ad
...
行业动向
LLM开源发展
https://mp.weixin.qq.com/s/D58GfDHogMS43Dl75fostw
LLM开源2.0大洗牌：60个出局，39个上桌，AI Coding疯魔，TensorFlow已死 (9月 2.0)
https://mp.weixin.qq.com/s/OmwI3viEQKh3Vj3WhRKSUA
135 个项目、七大趋势、三大赛道：撕开大模型开源生态真相，你会怎么卷？(5月 1.0)
https://github.com/antgroup/llm-oss-landscape
LLM Open Source Landscape and Trends
模型发展
清华唐杰：领域大模型，伪命题
https://mp.weixin.qq.com/s/krtUS58RrBX4UHnMZLPy4w
原理讲解
大模型架构
The Big LLM Architecture Comparison
https://magazine.sebastianraschka.com/p/the-big-llm-architecture-comparison
模型比较
AI 模型与基准测试分析的网站，包括智能水平、推理速度和价格等多个维度的榜单
...
Agentic Coding 的边界
https://mp.weixin.qq.com/s/x_FUUG4wBUqYs1H5DUtpgQ


Scaling Pain：超大规模 Coding Agent 推理实践
