...
source_url: "https://www.latent.space/p/reviews-dead"
domain: "latent.space"
description: "A case for moving human review upstream from pull request diffs to specs, verification layers, and deterministic guardrails in AI-native development."
...
*Second wave [speakers for AIE Europe](https://ai.engineer/europe) and [CFP for AIE World’s Fair](https://ai.engineer/wf) are announced today, and [OpenCode is confirmed for Miami](https://x.com/AIEMiami/status/2028546958239973420)! We’ll also be in [Melbourne](https://webdirections.org/ai-engineer/) & [Singapore](https://www.ai.engineer/singapore).*

*Editor: This is the latest in [our guest post program](https://docs.google.com/forms/d/e/1FAIpQLSeHQAgupNkVRgjNfMJG9d7SFTWUytdS6SNCJVkd0SMNMXHHwA/viewform?usp=dialog), where we will publish AI Engineering essays worth considering, even if we don’t personally agree with them — having just shipped an [AI review tool](https://x.com/cognition/status/2014079905755955592?s=20), this is one of those cases where I am not there yet, but is clearly on the horizon, and am happy for [Ankit](https://x.com/ankitxg) to argue the case!*
...
![](https://substackcdn.com/image/fetch/$s_!AC1C!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc8dc3ebd-973c-4d94-bb3e-1a2b77615f28_1250x830.png)
...
![](https://substackcdn.com/image/fetch/$s_!FNKE!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc28f86d4-01ff-4bce-b152-33d4d9f82683_1958x1082.png)
...
![](https://substackcdn.com/image/fetch/$s_!KO8y!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7f947125-827d-45c0-8868-21cc6903053f_1522x442.png)
