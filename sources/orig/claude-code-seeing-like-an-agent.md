...
domain: "x.com"
description: "A Claude Code team thread on designing an agent action space by learning to see from the model's perspective."
retrieved_at: "2026-06-05T21:16:57+08:00"
extractor: "defuddle"
---

![Cover image](https://pbs.twimg.com/media/HCLxeR3acAAf2R9.jpg)

One of the hardest parts of building an agent harness is constructing its action space.

Claude acts through Tool Calling, but there are a number of ways tools can be constructed in the Claude API with primitives like bash, skills and recently code execution (read more about programmatic tool calling on the Claude API in [@RLanceMartin](https://x.com/RLanceMartin)'s new article).
