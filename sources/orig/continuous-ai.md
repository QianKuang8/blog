---
title: "Continuous AI"
source_url: "https://githubnext.com/projects/continuous-ai"
domain: "githubnext.com"
description: "GitHub Next introduces Continuous AI as automated AI support for software collaboration, analogous to CI/CD."
...
To explore Continuous AI on GitHub today, we have developed a partner project, [GitHub Agentic Workflows](https://githubnext.com/projects/agentic-workflows/), which provides a powerful way to create agentic Continuous AI workflows using natural language.

Explore the docs and examples for GitHub Agentic Workflows at [github.com/githubnext/gh-aw](https://githubnext.github.io/gh-aw/)
...
A very powerful approach to Continuous AI is through fully or partially “agentic” workflows. Our project [GitHub Agentic Workflows](https://githubnext.com/projects/agentic-workflows/) provides a powerful way to create agentic Continuous AI workflows using natural language. The example workflows at [The Agentics](https://github.com/githubnext/agentics/) include a variety of Continuous AI examples, including Continuous Documentation, Continuous Triage, Continuous Test Improvement and Contiuous Performance Improvement.
...
We have now published [GitHub Agentic Workflows](https://githubnext.com/projects/agentic-workflows/) which provide a powerful way to create Continuous AI workflows using natural language.
