...
source_url: "https://openai.com/zh-Hans-CN/index/unrolling-the-codex-agent-loop/"
domain: "openai.com"
author:
...
![标题为“Agent loop”的示意图，展示了 AI 系统如何处理用户请求、调用工具、观察结果、更新计划并返回输出。箭头连接用户输入、模型推理、工具操作和最终响应等步骤。](https://images.ctfassets.net/kftzwdyauwt9/4ZoHTAsUlfq4eyu8D6yDSz/dba20936bb96d1e45e24a50af670fb78/oai_Unrolling_the_Codex_agent_loop_Agent_loop_desktop-dark.svg?w=3840&q=80)

标题为“Agent loop”的示意图，展示了 AI 系统如何处理用户请求、调用工具、观察结果、更新计划并返回输出。箭头连接用户输入、模型推理、工具操作和最终响应等步骤。
...
](https://openai.com/zh-Hans-CN/index/beyond-rate-limits/)[工程技术：在智能体优先的世界中利用 Codex](https://openai.com/zh-Hans-CN/index/harness-engineering/)
